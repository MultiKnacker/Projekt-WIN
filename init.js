 ...
 const employees = [
  ...
  { _id: ObjectId(), lastname: 'Schulz', firstname: 'Markus', job: 'Zentralleiter', streetname: 'Marienplatz 8', region: 'München', zipcode: '80331', monthly_wage: 1900.00 },
  { _id: ObjectId(), lastname: 'Peters', firstname: 'Robert', job: 'Fahrzeugwartung', streetname: 'Ettore-Bugatti-Straße 1', region: 'Köln', zipcode: '51149', monthly_wage: 1300.00 },
  { _id: ObjectId(), lastname: 'Berger', firstname: 'Andreas', job: 'Gutachter', streetname: 'Am Burghof 55', region: 'Frankfurt', zipcode: '60437', monthly_wage: 2500.00 },
  ...
  { _id: ObjectId(), lastname: 'Meyer', firstname: 'Stefan', job: 'Zentralleiter', streetname: 'Potsdamer Platz 1', region: 'Berlin', zipcode: '10785', monthly_wage: 3100.00 },
  { _id: ObjectId(), lastname: 'Wagner', firstname: 'Andreas', job: 'Fahrzeugwartung', streetname: 'Kurfürstendamm 237', region: 'Berlin', zipcode: '10719', monthly_wage: 1500.00 },
  { _id: ObjectId(), lastname: 'Becker', firstname: 'Martin', job: 'Gutachter', streetname: 'Tauentzienstraße 9', region: 'Berlin', zipcode: '10789', monthly_wage: 1500.00 },
  ...
  { _id: ObjectId(), lastname: 'Meyer', firstname: 'Stefan', job: 'Zentralleiter', streetname: 'Marienplatz 8', region: 'München', zipcode: '80331', monthly_wage: 1100.00 },
  { _id: ObjectId(), lastname: 'Jung', firstname: 'Andreas', job: 'Fahrzeugwartung', streetname: 'Marienplatz 8', region: 'München', zipcode: '80331', monthly_wage: 1900.00 },
  { _id: ObjectId(), lastname: 'Hahn', firstname: 'Martin', job: 'Gutachter', streetname: 'Marienplatz 8', region: 'München', zipcode: '80331', monthly_wage: 1300.00 },
  ...
  { _id: ObjectId(), lastname: 'Schulz', firstname: 'Stefan', job: 'Zentralleiter', streetname: 'Ettore-Bugatti-Straße 1', region: 'Köln', zipcode: '51149', monthly_wage: 900.00 },
  { _id: ObjectId(), lastname: 'Maier', firstname: 'Andreas', job: 'Fahrzeugwartung', streetname: 'Ettore-Bugatti-Straße 1', region: 'Köln', zipcode: '51149', monthly_wage: 1200.00 },
  { _id: ObjectId(), lastname: 'Lehmann', firstname: 'Martin', job: 'Gutachter', streetname: 'Ettore-Bugatti-Straße 1', region: 'Köln', zipcode: '51149', monthly_wage: 2100.00 },
  ...
  { _id: ObjectId(), lastname: 'Möller', firstname: 'Stefan', job: 'Zentralleiter', streetname: 'Am Burghof 55', region: 'Frankfurt', zipcode: '60437', monthly_wage: 1200.00 },
  { _id: ObjectId(), lastname: 'Weiss', firstname: 'Andreas', job: 'Fahrzeugwartung', streetname: 'Am Burghof 55', region: 'Frankfurt', zipcode: '60437', monthly_wage: 1300.00 },
  { _id: ObjectId(), lastname: 'Hahn', firstname: 'Martin', job: 'Gutachter', streetname: 'Am Burghof 55', region: 'Frankfurt', zipcode: '60437', monthly_wage: 1900.00 },
  ...
  { _id: ObjectId(), lastname: 'Winkler', firstname: 'Stefan', job: 'Zentralleiter', streetname: 'Unterländer Straße 66-68', region: 'Stuttgart', zipcode: '70435', monthly_wage: 2300.00 },
  { _id: ObjectId(), lastname: 'Beck', firstname: 'Andreas', job: 'Fahrzeugwartung', streetname: 'Unterländer Straße 66-68', region: 'Stuttgart', zipcode: '70435', monthly_wage: 1800.00 },
  { _id: ObjectId(), lastname: 'Roth', firstname: 'Martin', job: 'Gutachter', streetname: 'Unterländer Straße 66-68', region: 'Stuttgart', zipcode: '70435', monthly_wage: 1900.00 },
 ...
 const centrals = [
  { _id: ObjectId(), name: 'Zentrale Hamburg', location: 'Flughafen', streetname: 'Herberstraße 20', region: 'Hamburg', zipcode: '20359', rent: 1000.00 , employees: [employees[0]._id,employees[1]._id,employees[2]._id,employees[3]._id], vehicles: [vehicles[0]._id, vehicles[1]._id, vehicles[2]._id, vehicles[3]._id, vehicles[4]._id] },
  { _id: ObjectId(), name: 'Zentrale Berlin', location: 'Bahnhof', streetname: 'Bahnhofstraße 1', region: 'Berlin', zipcode: '10115', rent: 1200.00, employees: [employees[4]._id,employees[5]._id,employees[6]._id], vehicles: [vehicles[5]._id,vehicles[6]._id,vehicles[7]._id,vehicles[8]._id,vehicles[9]._id] },
  { _id: ObjectId(), name: 'Zentrale München', location: 'Innenstadt', streetname: 'Marienplatz 8', region: 'München', zipcode: '80331', rent: 3000.00, employees: [employees[7]._id,employees[8]._id,employees[9]._id], vehicles: [vehicles[10]._id,vehicles[11]._id,vehicles[12]._id,vehicles[13]._id,vehicles[14]._id] },
  { _id: ObjectId(), name: 'Zentrale Köln', location: 'Industriegebiet', streetname: 'Ettore-Bugatti-Straße 1', region: 'Köln', zipcode: '51149', rent: 4500.00, employees: [employees[10]._id,employees[11]._id,employees[12]._id], vehicles: [vehicles[15]._id,vehicles[16]._id,vehicles[17]._id,vehicles[18]._id,vehicles[19]._id] },
  { _id: ObjectId(), name: 'Zentrale Frankfurt', location: 'Ländlich', streetname: 'Am Burghof 55', region: 'Frankfurt', zipcode: '60437', rent: 2000.00, employees: [employees[13]._id,employees[14]._id,employees[15]._id], vehicles: [vehicles[20]._id,vehicles[21]._id,vehicles[22]._id,vehicles[23]._id,vehicles[24]._id] },
  { _id: ObjectId(), name: 'Zentrale Stuttgart', location: 'Hafen', streetname: 'Unterländer Straße 66-68', region: 'Stuttgart', zipcode: '70435', rent: 3500.00, employees: [employees[16]._id,employees[17]._id,employees[18]._id], vehicles: [vehicles[25]._id,vehicles[26]._id,vehicles[27]._id,vehicles[28]._id,vehicles[29]._id] },
  { _id: ObjectId(), name: 'Zentrale Düsseldorf', location: 'Flughafen', streetname: 'Flughafenstraße 120', region: 'Düsseldorf', zipcode: '40474', rent: 4000.00, employees: [employees[19]._id,employees[20]._id,employees[21]._id], vehicles: [vehicles[30]._id,vehicles[31]._id,vehicles[32]._id,vehicles[33]._id,vehicles[34]._id] },
  { _id: ObjectId(), name: 'Zentrale Leipzig', location: 'Bahnhof', streetname: 'Willy-Brandt-Platz 5', region: 'Leipzig', zipcode: '04109', rent: 2500.00, employees: [employees[22]._id,employees[23]._id,employees[24]._id], vehicles: [vehicles[30]._id,vehicles[31]._id,vehicles[32]._id,vehicles[33]._id,vehicles[34]._id] },
  { _id: ObjectId(), name: 'Zentrale Dresden', location: 'Innenstadt', streetname: 'Altmarkt 10', region: 'Dresden', zipcode: '01067', rent: 3000.00, employees: [employees[25]._id,employees[26]._id,employees[27]._id], vehicles: [vehicles[35]._id,vehicles[36]._id,vehicles[37]._id,vehicles[38]._id,vehicles[39]._id] },
  { _id: ObjectId(), name: 'Zentrale Hannover', location: 'Industriegebiet', streetname: 'Heinkelstraße 8', region: 'Hannover', zipcode: '30827', rent: 4500.00, employees: [employees[28]._id,employees[29]._id,employees[30]._id], vehicles: [vehicles[40]._id,vehicles[41]._id,vehicles[42]._id,vehicles[43]._id,vehicles[44]._id] },
  { _id: ObjectId(), name: 'Zentrale Nürnberg', location: 'Ländlich', streetname: 'Am Wegfeld 60', region: 'Nürnberg', zipcode: '90427', rent: 2000.00, employees: [employees[31]._id,employees[32]._id,employees[33]._id], vehicles: [vehicles[50]._id,vehicles[51]._id,vehicles[52]._id,vehicles[53]._id,vehicles[54]._id] }
 ];
 db.central.insertMany(centrals);

 const keydata = [
   { quater: 1, revenue: 300000, cost: 150000, year: 2024 },
   { quater: 2, revenue: 200000, cost: 100000, year: 2024 },
   { quater: 3, revenue: 250000, cost: 110000, year: 2024 },
 ];
